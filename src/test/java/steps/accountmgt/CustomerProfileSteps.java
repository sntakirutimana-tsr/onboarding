...
public class CustomerProfileSteps {
  ...
  public void customer_is_logged_in_with_credentials(String email, String password) {
    driver = DriverFactory.getDriver();
    accountPage = new AccountPage(driver);
//    accountPage.registerAccount();
    accountPage.load("/account/");

    driver.findElement(By.id("username")).sendKeys(email);
    driver.findElement(By.id("password")).sendKeys(password);
    driver.findElement(By.id("loginButton")).click();
//
//    // Verify login successful (assuming dashboard visible)
//    Assert.assertTrue("Customer is not logged in.",
//      driver.getCurrentUrl().contains("dashboard"));
  }

//  @When("Customer navigates to the Profile page")
//  public void customer_navigates_to_profile_page() {
