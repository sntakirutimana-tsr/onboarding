...
Feature: Browse product results with pagination
  ...
  Scenario Outline: Customer navigates forward through paginated results
    ...
    When a Customer navigates through page results using "<control>"
    ...
    Examples:
      | control        | current_page | results_message            |
      | forward button | 2            | Showing 9–13 of 13 results |
      | page number 2  | 2            | Showing 9–13 of 13 results |
  ...
  Scenario Outline: Customer navigates backward through paginated results
    ...
    Examples:
      | control         | current_page | results_message           |
      | backward button | 1            | Showing 1–8 of 13 results |
      | page number 1   | 1            | Showing 1–8 of 13 results |