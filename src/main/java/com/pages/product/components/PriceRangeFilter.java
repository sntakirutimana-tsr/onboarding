...
import static com.utils.FormatUtils.f;
...
public final class PriceRangeFilter extends Component {
  ...
  public Page applyFilter(String pageName) {
    button.click();
    waitForDisappearance(getRoot(), 10);
  ...
  public void ensureAllCheckpointsAreReady() {
    ...
    ensureExistenceOfElement(By.cssSelector(".price_slider span.ui-slider-handle:nth-of-type(1)"));
    ensureExistenceOfElement(By.cssSelector(".price_slider span.ui-slider-handle:nth-of-type(2)"));
